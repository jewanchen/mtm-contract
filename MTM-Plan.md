...
> 核心精神:**只問難回頭的岔路、其餘自己推 default;問的時候逼使用者『指一個能想像的未來』,不是點頭一個聽不懂的架構詞。**
...
*MTM Plan v0.1（隨 CORE v0.4）。三方獨立評審(完整性/小白UX/邊界)GO-with-additions 後定稿。下個綠地 task 實跑後回 `EVOLUTION.md` ledger 調整。*
