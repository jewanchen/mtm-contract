...
Since then the specification has moved to **2.0**: one unified lifecycle, a greenfield branch, and an evolution engine — built around a single idea, *put the cheap checks before the expensive generation*.
